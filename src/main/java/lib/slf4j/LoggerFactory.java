...
import lib.slf4j.event.SubstituteLoggingEvent;
import lib.slf4j.helpers.NOPLoggerFactory;
import lib.slf4j.helpers.SubstituteLogger;
import lib.slf4j.helpers.SubstituteLoggerFactory;
import lib.slf4j.helpers.Util;
import lib.slf4j.impl.StaticLoggerBinder;
...
public final class LoggerFactory {
    ...
    static final String UNSUCCESSFUL_INIT_MSG = "lib.slf4j.LoggerFactory in failed state. Original exception was thrown EARLIER. See also " + UNSUCCESSFUL_INIT_URL;
    ...
    private final static void bind() {
        try {
            ...
            if (messageContainsOrgSlf4jImplStaticLoggerBinder(msg)) {
                ...
                Util.report("Faild to load class \"lib.slf4j.impl.StaticLoggerBinder\".");
            ...
            if (msg != null && msg.contains("lib.slf4j.impl.StaticLoggerBinder.getSingleton()")) {
    ...
    private static boolean messageContainsOrgSlf4jImplStaticLoggerBinder(String msg) {
        ...
        if (msg.contains("org/slf4j/impl/StaticLoggerBinder"))
            return true;
        if (msg.contains("lib.slf4j.impl.StaticLoggerBinder"))
            return true;
        return false;
    }
