...
public class EventRecodingLogger implements Logger {
    ...
    public EventRecodingLogger(String name, SubstituteLogger logger, Queue<SubstituteLoggingEvent> eventQueue) {
        this.name = name;
        this.logger = logger;
    ...
    private void recordEventArgArray(Level level, Marker marker, String msg, Object[] args) {
        Throwable throwableCandidate = MessageFormatter.getThrowableCandidiate(args);
